...
def main():
    ...
    side += ['</nav>'
             ...
             '<div class="side-foot">'
             '<a href="https://github.com/moonbitstack/moonkoog/actions"><img alt="CI" src="https://img.shields.io/github/actions/workflow/status/moonbitstack/moonkoog/ci.yml?branch=master&label=CI&logo=github"></a>'
             '<a href="https://mooncakes.io/docs/moonbitstack/moonkoog"><img alt="mooncakes" src="https://img.shields.io/badge/mooncakes-Lfan--ke%2Fmoonorm-1f6feb"></a>'
             '</div></aside>']
    ...
    hero = ('<main><header class="hero"><h1>moonorm</h1>'
            ...
            '<a href="https://github.com/moonbitstack/moonkoog"><img alt="GitHub" src="https://img.shields.io/badge/GitHub-source-24292f?logo=github"></a>'
            '<img alt="license" src="https://img.shields.io/badge/license-Apache--2.0-6d5efc"></div>'
            '<div class="install"><span class="prompt">$</span><code>moon add moonbitstack/moonkoog</code>'
            '<button class="copy" data-copy="moon add moonbitstack/moonkoog">copy</button></div>'
    ...
    body.append('<footer>Generated from source <code>///</code> doc-comments · '
                '<a href="https://mooncakes.io/docs/moonbitstack/moonkoog">mooncakes</a> · '
                '<a href="https://github.com/moonbitstack/moonkoog">GitHub</a> · Apache-2.0 &#169; Leo Cheng</footer>')
